 ...
 * </p>
 * <ul>
 *   <li>{@link caex.caex30.caex.impl.CAEXObjectImpl#getID <em>ID</em>}</li>
 *   <li>{@link caex.caex30.caex.impl.CAEXObjectImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CAEXObjectImpl extends CAEXBasicObjectImpl implements CAEXObject {
	...
	protected EClass eStaticClass() {
		return CAEXPackage.Literals.CAEX_OBJECT;
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CAEXPackage.CAEX_OBJECT__NAME, oldName, name));
	}
