 ...
 * </p>
 * <ul>
 *   <li>{@link caex.caex30.caex.impl.SystemUnitClassImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link caex.caex30.caex.impl.SystemUnitClassImpl#getExternalInterface <em>External Interface</em>}</li>
 *   <li>{@link caex.caex30.caex.impl.SystemUnitClassImpl#getInternalElement <em>Internal Element</em>}</li>
 *   <li>{@link caex.caex30.caex.impl.SystemUnitClassImpl#getSupportedRoleClass <em>Supported Role Class</em>}</li>
 *   <li>{@link caex.caex30.caex.impl.SystemUnitClassImpl#getInternalLink <em>Internal Link</em>}</li>
 *   <li>{@link caex.caex30.caex.impl.SystemUnitClassImpl#getBaseClass <em>Base Class</em>}</li>
 *   <li>{@link caex.caex30.caex.impl.SystemUnitClassImpl#getSystemUnitClass <em>System Unit Class</em>}</li>
 *   <li>{@link caex.caex30.caex.impl.SystemUnitClassImpl#getRefBaseClassPath <em>Ref Base Class Path</em>}</li>
 * </ul>
 *
 * @generated
 */
