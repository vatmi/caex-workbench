 ...
 * </p>
 * <ul>
 *   <li>{@link caex.caex30.caex.impl.AttributeImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link caex.caex30.caex.impl.AttributeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link caex.caex30.caex.impl.AttributeImpl#getRefSemantic <em>Ref Semantic</em>}</li>
 *   <li>{@link caex.caex30.caex.impl.AttributeImpl#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link caex.caex30.caex.impl.AttributeImpl#getAttribute <em>Attribute</em>}</li>
...
public class AttributeImpl extends CAEXObjectImpl implements Attribute {
	...
	public void setRefAttributeType(String newRefAttributeType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CAEXPackage.ATTRIBUTE__REF_ATTRIBUTE_TYPE, oldRefAttributeType, refAttributeType));
	}
