...
/**
 * This is the item provider adapter for a {@link caex.caex30.caex.CAEXObject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CAEXObjectItemProvider extends CAEXBasicObjectItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CAEXObjectItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CAEXObject"));
	}
	...
	public String getText(Object object) {
		String label = ((CAEXObject)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CAEXObject_type") :
			getString("_UI_CAEXObject_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CAEXObject.class)) {
